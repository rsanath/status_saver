...
export default class VideoPlayer extends Component {
    ...
    componentDidMount() {
        if (this.props.autoplay) {
            this.hideControls(this.props.controlsTimeout);
        }
    }
    ...
    onSeekGrant(e) {
        this.props.onSeekingStart && this.props.onSeekingStart();
    ...
    onSeekRelease() {
        this.props.onSeekingEnd && this.props.onSeekingEnd();
                ...
                {this.props.muted ? null : (
                    <TouchableOpacity onPress={this.onMutePress} style={customStyles.controlButton}>
                        <Icon
                            ...
                            name={this.state.isMuted ? 'volume-mute' : 'volume-up'}
                            size={25}
                        />
                    </TouchableOpacity>
                )}
            ...
            <View style={customStyles.videoWrapper}>
                ...
                <View
                    ...
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            this.state.isControlsVisible ? this.hideControls(0) : this.showControls()
                            if (pauseOnPress)
                                this.onPlayPress();
                        }}
                        onLongPress={() => {
